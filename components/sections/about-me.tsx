        ...
        <div className="flex min-h-[calc(100vh-53px)] flex-col md:flex-row">
          ...
          <div className="flex flex-1 flex-col justify-between border-r border-ca-rule px-6 py-10 md:px-14 lg:px-20">
            ...
            >
              ...
              <p className="font-jakarta text-sm leading-relaxed text-ca-paper/60">
                Hi, I'm{" "}
                <span className="font-semibold text-ca-neon">Charles</span>{" "}
                <span className="font-semibold text-ca-hot">/ tʃɑːrlz /</span>{" "}
                    ...
                    <div className="mt-5 space-y-4">
                      {EXTENDED.map((para, i) => (
                        <motion.p
                          ...
                          className="font-jakarta text-sm leading-relaxed text-ca-paper/60"
                        >
                          {para}
                        </motion.p>
                      ))}
